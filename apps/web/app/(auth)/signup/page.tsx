...
export default function Signup() {
  return (
    <>
      <Navbar />
      <section className="container mx-auto px-4 py-10 sm:py-12 lg:py-44">
        <div className="flex flex-col gap-10 divide-y divide-border lg:flex-row lg:gap-16 lg:divide-y-0 lg:divide-x">
          ...
          <div className="space-y-6 lg:flex-1">
            <div className="space-y-6 lg:flex-1 flex flex-col justify-center">
              <section
              ...
              >
                ...
                <footer className="pt-6" aria-label="Clients de confiance">
                  <p className="text-xs text-zinc-500 text-center mb-4">
                    Rejoignez des entreprises de premier plan en utilisant
                    l’outil de planification n° 1
                  </p>
